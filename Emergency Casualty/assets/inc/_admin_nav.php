<nav class="navbar navbar-expand-sm navbar-light text-white bg-light">
    <a class="navbar-brand" href="#">
        <marquee direction="right">Casualty Management</marquee></a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link" href="emergency.php">Emergencies</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="dispatch.php">Dispatchers</a>
            </li>
            <li class="nav-item">
